...
if (!hasAccess('Access Barangay ID - Admin')) {
...
<head>
  ...
  <title>Admin Barangay ID — Barangay 101</title>
  ...
  <div class="main-content">
    ...
    <div class="content-container">
      ...
      <div class="page-header">
        <div>
          <h1 class="page-title">Admin: Barangay ID Requests</h1>
          <p class="page-subtitle">Manage, process, override, and track all Barangay ID requests</p>
        </div>
        ...
        <div class="cert-table-col" id="certTableCol">
          ...
          <div class="panel cert-panel">
            <div class="panel-header">
              <div>
                <p class="panel-title">Barangay ID Request Queue</p>
...
<script src="<?php echo get_fresh_asset('JS/Admin_js/admin_barangay_id.js'); ?>"></script>
</body>
</html>