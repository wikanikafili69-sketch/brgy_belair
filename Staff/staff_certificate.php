...
if (!hasAccess('Access Certificate - Staff')) {
...
<head>
  ...
  <title>Certificate Requests — Barangay 101</title>
    ...
    <div class="content-container">
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Manage, process, and track all certificate requests</p>
        </div>
      </div>
          ...
          <div class="res-toolbar">
            ...
            <div class="toolbar-filters">
              ...
              <select class="filter-select" id="filterCertSource">
                ...
                <option value="W">Walk-in Only</option>
...
<script src="<?php echo get_fresh_asset('JS/Staff_js/staff_certificate.js'); ?>"></script>
</body>
</html>