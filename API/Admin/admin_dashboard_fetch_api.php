...
try {
    ...
    $where_clause = "WHERE DATE(created_at) = :fdate AND LOWER(service_type) NOT LIKE '%barangay id%'";
    ...
    try {
        ...
        $summary_where = "WHERE DATE(created_at) = :fdate AND LOWER(service_type) NOT LIKE '%barangay id%'";
